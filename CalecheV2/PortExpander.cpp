...
void PortExpander::start() 
{
  ...
  //mosfets
  pinModeMCP23S17('A', MOSFET_1_PIN, OUTPUT);
  pinModeMCP23S17('A', MOSFET_2_PIN, OUTPUT);
  pinModeMCP23S17('A', MOSFET_3_PIN, OUTPUT);
  pinModeMCP23S17('A', MOSFET_4_PIN, OUTPUT);
  pinModeMCP23S17('A', MOSFET_5_PIN, OUTPUT);

  digitalWriteMCP23S17('A', MOSFET_1_PIN, LOW);
  digitalWriteMCP23S17('A', MOSFET_2_PIN, LOW);
  digitalWriteMCP23S17('A', MOSFET_3_PIN, LOW);
  digitalWriteMCP23S17('A', MOSFET_4_PIN, LOW);
  digitalWriteMCP23S17('A', MOSFET_5_PIN, LOW);
